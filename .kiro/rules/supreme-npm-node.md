...
description: Principal NPM/NPX/NPMJS/Node engineering with latest-version-always policy via ncu -u, TypeScript strict mode, package.json discipline, OIDC provenance, supply-chain audit, pnpm workspaces. On-demand in Kiro.
