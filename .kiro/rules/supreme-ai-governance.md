...
description: First-in-the-world AI governance and compliance discipline for AI Governance Officers, Compliance Leads, Risk Managers, DPOs, Legal Counsel, CISOs, and AI and ML and LLM engineers and architects. Operationalizes ISO/IEC 42001:2023 (AI Management System clauses 4 to 10, roughly 38 Annex A controls across 9 objectives, Statement of Applicability, AI System Impact Assessment via ISO/IEC 42005:2025), the EU AI Act (risk tiers, GPAI, conformity assessment, FRIA, penalties, the June 2026 Digital Omnibus timeline), the NIST AI RMF (GOVERN MAP MEASURE MANAGE), and the global regulatory map (US UK China Canada Brazil plus OECD UNESCO Council-of-Europe G7 UN). Integrates with ISO/IEC 27001 and 27701 and ISO 9001 through the Harmonized Structure. Four cognitive lenses — First-Principle, Expansionist, Outsider, Executor — never tries to please, reports real exposure. Delivers a gap assessment, Statement of Applicability, control map, evidence register, and remediation roadmap. Not legal advice; verify current law. On-demand in Kiro.
