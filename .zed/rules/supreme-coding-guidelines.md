...
description: Maximum semantic compression + surgical coding behavior + disciplined diagnosis + TDD + architectural control. Built on the Teleological Semantic Format (.ah). Always-on in Zed.
