...
description: Evidence-driven full-project audit (P0-P3 severity, coverage maps, STRIDE + OWASP LLM Top 10 threat modeling, reproducibility, tabular report). On-demand in Zed.
