...
description: Evidence-driven full-project audit for Product/AI/ML/LLM engineers, LLM architects, and AI researchers. Severity discipline (P0/P1/P2/P3), coverage maps, STRIDE + OWASP LLM Top 10 threat modeling, reproducibility checks, terse tabular report. On-demand in Claude Code.
